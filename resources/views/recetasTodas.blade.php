				...
				@foreach ($recetas as $receta)
					<div class="card col-4">
			  			<div class="card-body">
				    		...
				    		<a href="/receta/edicion/{{  $receta->id }}" class="btn btn-primary float-left"><i class="far fa-edit"></i> Editar receta</a><br><br>
				    		<form action="/receta/edicion/{{  $receta->id }}" class="" method="post">
								@method('DELETE')
								@csrf
